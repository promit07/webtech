...
<body>
	...
	<?php include '../control/editprofilecontrolnew.php';?>
			...
			<tr>
				...
				<td width="75%">
					<fieldset>
						...
						<!--<form method="post" action="../control/editprofilecontrolnew.php">-->
								<legend>Name</legend>
								<input type="text" name="fname" value="<?= $_SESSION['name']?>"><span style="color: red;"><?php //echo $nameErr ?></span>
								<hr>
